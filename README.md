...
## Kubernetes (k8s)
* [Childrens Guide to Kubernetes (YouTube)](https://www.youtube.com/watch?v=4ht22ReBjno)
* [Kubernetes The Hard Way](https://github.com/kelseyhightower/kubernetes-the-hard-way)
* [Julia Evans Kubernetes 'zines](https://jvns.ca/blog/2017/06/04/learning-about-kubernetes/)
* [Joe Beda (co-founder) hosts a weekly interactive k8s webcast every friday](https://www.youtube.com/watch?v=9YYeE-bMWv8)
* [Kubernetes GitHub](https://github.com/kubernetes/kubernetes)
* [Kubernetes Keynote by Kelsey Hightower](https://www.youtube.com/watch?v=8SvQqZNP6uo)
...
* [Building & Running Microservices on OpenShift](https://www.youtube.com/watch?v=-UZBy9FeCYQ)
* [Container Orchestration with OpenShift](https://www.youtube.com/watch?v=WYNDRAioenI)
* [A MongoDB view of OpenShift/Kubernetes](https://www.youtube.com/watch?v=F_BuRIAnvqE)
* [OpenShift CheatSheet](https://github.com/nekop/openshift-sandbox/blob/master/docs/command-cheatsheet.md)
* [The differences between Kubernetes & OpenShift](https://medium.com/levvel-consulting/the-differences-between-kubernetes-and-openshift-ae778059a90e)
